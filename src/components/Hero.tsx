...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative flex items-center justify-center min-h-screen bg-[var(--color-light-bg)] overflow-hidden pt-[120px] pb-[60px]"
    >
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-[5%] md:px-[8%] flex flex-col md:flex-row items-center justify-between gap-[50px] lg:gap-[100px]">
        ...
        {/* Left Content */}
        <div className="flex-1 max-w-[500px] mt-[40px] md:mt-0 relative z-20 bg-[var(--color-light-bg)]/50 backdrop-blur-sm md:bg-transparent md:backdrop-blur-none p-4 md:p-0 rounded-xl">
        ...
        {/* Right Content - Image */}
        <div className="flex-1 relative flex justify-center items-center w-full max-w-[500px] mt-[40px] md:mt-0">
