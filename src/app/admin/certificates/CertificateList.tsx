        ...
        <div key={c.id} className="border border-[var(--color-border)] bg-white p-4 flex flex-col gap-3 group hover:shadow-md transition-shadow">
          ...
          <div className="flex justify-end items-center pt-3 border-t border-gray-100">
             <div className="flex gap-4">
                <a href={c.repoUrl || "https://github.com/ZAndrie/portfolio-contents/tree/main/certificates"} target="_blank" rel="noreferrer" className="text-gray-500 text-[10px] uppercase font-bold hover:text-[var(--color-primary)] tracking-wider transition-colors">
                  GitHub ↗
                </a>
                <button 
